    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get('https://hospital-food-delivery-management-tau.vercel.app/api/dashboard/manager'); // Adjust the API endpoint as needed
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    <div className="card shadow-sm border-success">
                        <div className="card-body text-center">
                            <i className="bi bi-person-heart fs-1 text-success"></i>
                            <h5 className="card-title mt-3">Total Patients</h5>
                            <p className="card-text fs-4">{data.totalPatients}</p>
                        </div>
                    </div>
                </div>
