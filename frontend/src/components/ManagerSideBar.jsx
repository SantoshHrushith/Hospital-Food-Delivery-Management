            ...
            >
                <div className="nav-link text-center p-md-3 w-100">
                    <h3 className="poppins-light">
                        <span className="text-primary" style={{ color: 'rgb(104,179,185)' }} onClick={() => navigate('/managerhome')}>
                            Manager Panel
                        </span>
                    </h3>
                </div>
                ...
                <div className="nav-link p-md-2 ms-2 w-100" style={{ fontSize: '1.5rem' }}>
                    <button className="btn btn-link text-dark text-decoration-none w-100 text-start" onClick={() => navigate('/patients')}>
                        <i className="bi bi-people fs-3"></i>
                        <span className="ms-3">Patients & Diets</span>
                    </button>
                </div>
